...
public class FragmentoParceirosAdapter extends RecyclerView.Adapter<FragmentoParceirosAdapter.ViewHolder> {
    private List<ParceiroEntity> parceiroList;
    OnRecyclerViewSelected onRecyclerViewSelected;
    private Context context;

    FragmentoParceirosAdapter(List<ParceiroEntity> list, Context context){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txTelefoneParceiro.setText(parceiroEntity.getTelefone());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.telefone_parceiro)
        TextView txTelefoneParceiro;
