...
public class ListarParceirosAdapter extends RecyclerView.Adapter<ListarParceirosAdapter.ViewHolder> {
    private List<ParceiroEntity> parceiroList;
    OnRecyclerViewSelected onRecyclerViewSelected;
    private Context context;

    ListarParceirosAdapter(List<ParceiroEntity> list, Context context){
