...
public class CriaBD extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        String sqlEscalas = " DROP TABLE IF EXISTS " + TABESCALAS;
        db.execSQL(sqlAssistidos + "; "+ sqlResponsavelAssistido + "; "+ sqlMedicamentoAssistido + "; "+ sqlParceiros + "; " + sqlDoacoes + "; " + sqlEventos  + "; "+ sqlNotificacoes + "; "+ sqlMensagens + "; "+ sqlUsuarios + ";" + sqlEscalas);
        onCreate(db);
    }
    ...
    private void preencheMockups(SQLiteDatabase db) {
        ...
        //.execSQL(insertAssistidos.concat(values));
